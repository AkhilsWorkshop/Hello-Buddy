...
const Hero = () => {
    return (
        <div className="bg-gradient-to-br from-fourth via-third/30 to-fourth">
            <div className="max-w-screen-xl mx-auto flex flex-col-reverse md:flex-row items-center gap-10 p-8 md:p-10">
                ...
                <div className="flex flex-col flex-1 gap-5 text-secondary">
                    ...
                    <button className="flex items-center gap-2 self-start border-2 text-xl border-third rounded-lg p-3 text-fourth bg-secondary/90 hover:bg-third hover:border-primary/30 hover:text-secondary font-semibold duration-300 transition-all">
                        <p>Get started</p>
